...
namespace ApiAgendamento.Controllers
{
    ...
    public class AgendamentoController : ControllerBase
    {
        ...
        /// <response code="500">Erro interno ao processar a listagem.</response>
        [HttpGet]
        public async Task<IActionResult> ListarTodos()
        {
            ...
            {
                return StatusCode(500, "Ocorreu um erro interno ao tentar listar os agendamentos.");
            }
        }
        ...
        /// <response code="500">Erro interno ao tentar salvar o agendamento.</response>
        [HttpPost]
        public async Task<IActionResult> Criar(AgendamentoDTO dto)
        {
            ...
            {
                return StatusCode(500, "Erro ao processar o registro no banco de dados.");
            }
        }
        ...
        /// <response code="500">Erro interno ao buscar o registro.</response>
        [HttpGet("{id}")]
        public async Task<IActionResult> ObterPorId(int id)
        {
            ...
            {
                return StatusCode(500, "Erro ao buscar os dados do agendamento.");
            }
        }
        ...
        /// <response code="500">Erro de concorrência ou falha interna no servidor.</response>
        [HttpPut("{id}")]
        public async Task<IActionResult> Atualizar(int id, AgendamentoDTO dto)
        {
            ...
            {
                return StatusCode(500, "Erro ao atualizar o banco de dados (Concorrência).");
            }
            catch (Exception)
            {
                return StatusCode(500, "Ocorreu um erro inesperado ao atualizar o agendamento.");
            }
        }
        ...
        /// <response code="500">Erro interno ao tentar excluir o registro.</response>
        [HttpDelete("{id}")]
        public async Task<IActionResult> Excluir(int id)
        {
            ...
            {
                return StatusCode(500, "Ocorreu um erro interno ao tentar excluir o agendamento.");
            }
        }
    }
}